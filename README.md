...
[![Coverage](https://codecov.io/gh/abhishekbiyala/cliptunnel/graph/badge.svg)](https://codecov.io/gh/abhishekbiyala/cliptunnel)
...
Forward Mac clipboard images to remote Linux devboxes over SSH. Works with **every** coding CLI — Claude Code, Codex CLI, Gemini CLI, OpenCode CLI, and any future agent that reads the system clipboard.

Copy a screenshot on your Mac, press Ctrl+V in your remote coding agent, and it just works.
