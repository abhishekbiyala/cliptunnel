...
Before pushing to main or tagging a release:
...
9. Deploy fresh Linux binary to remote, run `cliptunnel doctor --host <host>` — 8/8 checks pass
10. Test clipboard image paste in at least one coding CLI (Claude Code or Codex)
